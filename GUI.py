...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Sat Nov 02 23:52:08 2013
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_11 = wx.StaticText(self.pnlSettingBar, wx.ID_ANY, "Script")
        self.static_line_2 = wx.StaticLine(self.pnlSettingBar, wx.ID_ANY)
        self.txtScriptDir = wx.TextCtrl(self.pnlSettingBar, wx.ID_ANY, "")
        self.btnSelectScript = wx.Button(self.pnlSettingBar, wx.ID_ANY, "...")
        self.btnTransmitScript = wx.Button(self.pnlSettingBar, wx.ID_ANY, "Transmit Script")
        ...
        self.chkRemoveSpace = wx.CheckBox(self.pnlSettingBar, wx.ID_ANY, "Remove the Space(s)")
    ...
    def __set_properties(self):
        ...
        self.btnOpen.SetMinSize((-1, 25))
        self.btnClear.SetMinSize((-1, 25))
        self.btnSelectScript.SetMinSize((25, -1))
    ...
    def __do_layout(self):
        ...
        sizer_3.Add(self.btnOpen, 0, wx.ALL | wx.EXPAND, 3)
        sizer_3.Add(self.btnClear, 0, wx.ALL | wx.EXPAND, 3)
        ...
        sizer_16.Add(self.label_11, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_16.Add(self.static_line_2, 1, wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_8.Add(sizer_16, 1, wx.EXPAND, 0)
        sizer_15.Add(self.txtScriptDir, 1, wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 1)
        sizer_15.Add(self.btnSelectScript, 0, wx.LEFT | wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 1)
        sizer_8.Add(sizer_15, 1, wx.EXPAND, 0)
        sizer_8.Add(self.btnTransmitScript, 0, wx.ALL | wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 1)
        ...
        sizer_8.Add(self.chkRemoveSpace, 0, wx.ALL | wx.EXPAND, 3)
        sizer_7.Add(sizer_8, 1, wx.EXPAND, 0)
        sizer_12.Add(sizer_7, 1, wx.ALL | wx.EXPAND, 2)
        sizer_3.Add(sizer_12, 0, wx.EXPAND, 0)
